...
/* =========================================================
   ...
   ========================================================= */
// Assumed reference year 2025 for all dates (year not specified in the source message).
const timelineData = [
  {date:new Date(2025,1,28,0,0), title:'28 فبراير', label:'يوم دخلتِ حياتي... يوم من أحلى أيامي.'},
  {date:new Date(2025,3,10,8,0), title:'10 أبريل — 8:00 صباحاً', label:'يوم قولتلك بحبك لأول مرة.'},
  {date:new Date(2025,6,2,0,0), title:'2 يوليو', label:'يوم من أصعب أيامي.'},
  {date:new Date(2025,6,18,0,0), title:'18 يوليو', label:'يوم رجعت فيا الروح تاني.'}
];
